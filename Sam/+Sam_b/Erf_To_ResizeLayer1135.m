classdef Erf_To_ResizeLayer1135 < nnet.layer.Layer & nnet.layer.Formattable
    ...
    properties (Learnable)
        ...
        onnx__Unsqueeze_1493
        onnx__Unsqueeze_1498
        onnx__Unsqueeze_1502
        onnx__Unsqueeze_1504
    end
    ...
    methods
        function this = Erf_To_ResizeLayer1135(name, onnxParams)
            ...
            this.onnx__Unsqueeze_1493 = onnxParams.Learnables.onnx__Unsqueeze_1493;
            this.onnx__Unsqueeze_1498 = onnxParams.Learnables.onnx__Unsqueeze_1498;
            this.onnx__Unsqueeze_1502 = onnxParams.Learnables.onnx__Unsqueeze_1502;
            this.onnx__Unsqueeze_1504 = onnxParams.Learnables.onnx__Unsqueeze_1504;
        end
        ...
        function [masks, low_res_masks] = predict(this, x_output_upscalin_25, x_output_upscalin_20, x_Concat_10_output_0, x_Cast_8_output_0, x_Concat_10_output_0NumDims, x_Cast_8_output_0NumDims)
            ...
            onnxParams.Learnables.onnx__Unsqueeze_1493 = this.onnx__Unsqueeze_1493;
            onnxParams.Learnables.onnx__Unsqueeze_1498 = this.onnx__Unsqueeze_1498;
            onnxParams.Learnables.onnx__Unsqueeze_1502 = this.onnx__Unsqueeze_1502;
            onnxParams.Learnables.onnx__Unsqueeze_1504 = this.onnx__Unsqueeze_1504;
...
% Unsqueeze:
[shape, NumDims.x_Unsqueeze_13_outpu] = prepareUnsqueezeArgs(Vars.x_Gather_11_output_0, Vars.onnx__Unsqueeze_1489, NumDims.x_Gather_11_output_0);
Vars.x_Unsqueeze_13_outpu = reshape(Vars.x_Gather_11_output_0, shape);

% Unsqueeze:
[shape, NumDims.x_Unsqueeze_14_outpu] = prepareUnsqueezeArgs(Vars.x_Gather_12_output_0, Vars.onnx__Unsqueeze_1491, NumDims.x_Gather_12_output_0);
Vars.x_Unsqueeze_14_outpu = reshape(Vars.x_Gather_12_output_0, shape);

% Unsqueeze:
[shape, NumDims.x_Unsqueeze_15_outpu] = prepareUnsqueezeArgs(Vars.x_Mul_11_output_0, Vars.onnx__Unsqueeze_1493, NumDims.x_Mul_11_output_0);
...
% Unsqueeze:
[shape, NumDims.x_Unsqueeze_16_outpu] = prepareUnsqueezeArgs(Vars.x_Gather_11_output_0, Vars.onnx__Unsqueeze_1498, NumDims.x_Gather_11_output_0);
Vars.x_Unsqueeze_16_outpu = reshape(Vars.x_Gather_11_output_0, shape);

% Unsqueeze:
[shape, NumDims.x_Unsqueeze_17_outpu] = prepareUnsqueezeArgs(Vars.x_Gather_13_output_0, Vars.onnx__Unsqueeze_1502, NumDims.x_Gather_13_output_0);
Vars.x_Unsqueeze_17_outpu = reshape(Vars.x_Gather_13_output_0, shape);

% Unsqueeze:
[shape, NumDims.x_Unsqueeze_18_outpu] = prepareUnsqueezeArgs(Vars.x_Gather_14_output_0, Vars.onnx__Unsqueeze_1504, NumDims.x_Gather_14_output_0);
