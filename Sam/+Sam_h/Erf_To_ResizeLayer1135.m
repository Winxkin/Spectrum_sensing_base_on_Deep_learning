classdef Erf_To_ResizeLayer1135 < nnet.layer.Layer & nnet.layer.Formattable
    ...
    properties (Learnable)
        onnx__Unsqueeze_1769
        onnx__Unsqueeze_1771
        onnx__Unsqueeze_1773
        onnx__Unsqueeze_1778
        onnx__Unsqueeze_1782
        onnx__Unsqueeze_1784
    end
    ...
    methods
        function this = Erf_To_ResizeLayer1135(name, onnxParams)
            ...
            this.onnx__Unsqueeze_1769 = onnxParams.Learnables.onnx__Unsqueeze_1769;
            this.onnx__Unsqueeze_1771 = onnxParams.Learnables.onnx__Unsqueeze_1771;
            this.onnx__Unsqueeze_1773 = onnxParams.Learnables.onnx__Unsqueeze_1773;
            this.onnx__Unsqueeze_1778 = onnxParams.Learnables.onnx__Unsqueeze_1778;
            this.onnx__Unsqueeze_1782 = onnxParams.Learnables.onnx__Unsqueeze_1782;
            this.onnx__Unsqueeze_1784 = onnxParams.Learnables.onnx__Unsqueeze_1784;
        end
        ...
        function [masks, low_res_masks] = predict(this, x_output_upscalin_25, x_output_upscalin_20, x_Concat_10_output_0, x_Cast_8_output_0, x_Concat_10_output_0NumDims, x_Cast_8_output_0NumDims)
            ...
            onnxParams.Learnables.onnx__Unsqueeze_1769 = this.onnx__Unsqueeze_1769;
            onnxParams.Learnables.onnx__Unsqueeze_1771 = this.onnx__Unsqueeze_1771;
            onnxParams.Learnables.onnx__Unsqueeze_1773 = this.onnx__Unsqueeze_1773;
            onnxParams.Learnables.onnx__Unsqueeze_1778 = this.onnx__Unsqueeze_1778;
            onnxParams.Learnables.onnx__Unsqueeze_1782 = this.onnx__Unsqueeze_1782;
            onnxParams.Learnables.onnx__Unsqueeze_1784 = this.onnx__Unsqueeze_1784;
...
% Unsqueeze:
[shape, NumDims.x_Unsqueeze_13_outpu] = prepareUnsqueezeArgs(Vars.x_Gather_11_output_0, Vars.onnx__Unsqueeze_1769, NumDims.x_Gather_11_output_0);
Vars.x_Unsqueeze_13_outpu = reshape(Vars.x_Gather_11_output_0, shape);

% Unsqueeze:
[shape, NumDims.x_Unsqueeze_14_outpu] = prepareUnsqueezeArgs(Vars.x_Gather_12_output_0, Vars.onnx__Unsqueeze_1771, NumDims.x_Gather_12_output_0);
Vars.x_Unsqueeze_14_outpu = reshape(Vars.x_Gather_12_output_0, shape);

% Unsqueeze:
[shape, NumDims.x_Unsqueeze_15_outpu] = prepareUnsqueezeArgs(Vars.x_Mul_11_output_0, Vars.onnx__Unsqueeze_1773, NumDims.x_Mul_11_output_0);
...
% Unsqueeze:
[shape, NumDims.x_Unsqueeze_16_outpu] = prepareUnsqueezeArgs(Vars.x_Gather_11_output_0, Vars.onnx__Unsqueeze_1778, NumDims.x_Gather_11_output_0);
Vars.x_Unsqueeze_16_outpu = reshape(Vars.x_Gather_11_output_0, shape);

% Unsqueeze:
[shape, NumDims.x_Unsqueeze_17_outpu] = prepareUnsqueezeArgs(Vars.x_Gather_13_output_0, Vars.onnx__Unsqueeze_1782, NumDims.x_Gather_13_output_0);
Vars.x_Unsqueeze_17_outpu = reshape(Vars.x_Gather_13_output_0, shape);

% Unsqueeze:
[shape, NumDims.x_Unsqueeze_18_outpu] = prepareUnsqueezeArgs(Vars.x_Gather_14_output_0, Vars.onnx__Unsqueeze_1784, NumDims.x_Gather_14_output_0);
