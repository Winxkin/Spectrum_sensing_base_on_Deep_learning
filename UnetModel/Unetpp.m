...
lUnetpp = connectLayers(lUnetpp,"Relu_20_1","concat_22_0/in3");     %fixed
...
lUnetpp = connectLayers(lUnetpp,"Relu_30_1","concat_31_0/in2");     %fixed
...
lUnetpp = connectLayers(lUnetpp,"Relu_11_1","concat_13_0/in3");     %fixed
...
lUnetpp = connectLayers(lUnetpp,"Relu_21_1","concat_22_0/in2");     %fixed
...
lUnetpp = connectLayers(lUnetpp,"Relu_12_1","concat_13_0/in2");     %fixed
lUnetpp = connectLayers(lUnetpp,"resize-scale_12_0","concat_03_0/in2");
lUnetpp = connectLayers(lUnetpp,"resize-scale_13_0","concat_04_0/in1"); %fixed
