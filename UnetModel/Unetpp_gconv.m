...
lUnetpp_gconv = connectLayers(lUnetpp_gconv,"Relu_20_1","concat_22_0/in3");     %fixed
...
lUnetpp_gconv = connectLayers(lUnetpp_gconv,"Relu_30_1","concat_31_0/in2");     %fixed
...
lUnetpp_gconv = connectLayers(lUnetpp_gconv,"Relu_11_1","concat_13_0/in3");     %fixed
...
lUnetpp_gconv = connectLayers(lUnetpp_gconv,"Relu_40_3","concat_31_0/in1");     %fixed
...
lUnetpp_gconv = connectLayers(lUnetpp_gconv,"Relu_21_1","concat_22_0/in2");             %fixed
...
lUnetpp_gconv = connectLayers(lUnetpp_gconv,"Relu_12_1","concat_13_0/in2");             %fixed
lUnetpp_gconv = connectLayers(lUnetpp_gconv,"resize-scale_12_0","concat_03_0/in2");
lUnetpp_gconv = connectLayers(lUnetpp_gconv,"resize-scale_13_0","concat_04_0/in1");      %fixed
lUnetpp_gconv = connectLayers(lUnetpp_gconv,"Relu_03_1","concat_04_0/in2");

%% Connect to output layer
lUnetpp_gconv = connectLayers(lUnetpp_gconv,"sigmoidLayer_04_0","conv_Output_0");

%% Plot
plot(lUnetpp_gconv);
analyzeNetwork(lUnetpp_gconv);