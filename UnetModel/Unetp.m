...
lUnetp = connectLayers(lUnetp,"Relu_30_1","concat_31_0/in2");
...
lUnetp = connectLayers(lUnetp,"Relu_40_3","concat_31_0/in1");
...
lUnetp = connectLayers(lUnetp,"Relu_21_1","concat_22_0/in2");
...
lUnetp = connectLayers(lUnetp,"Relu_12_1","concat_13_0/in2");
lUnetp = connectLayers(lUnetp,"resize-scale_12_0","concat_03_0/in2");
lUnetp = connectLayers(lUnetp,"resize-scale_13_0","concat_04_0/in1");
lUnetp = connectLayers(lUnetp,"Relu_03_1","concat_04_0/in2");  

%% Connect to ouput layer
lUnetp = connectLayers(lUnetp,"sigmoidLayer_04_0","conv_Output_0");

plot(lUnetp);
analyzeNetwork(lUnetp);
